...
{$ENDIF}
  ...
  iORM.DT.VMActnListCompEd,
  iORM.DT.VMActionEditor
...
{$ENDIF}
  ...
  // MVVM - VMActions: register for design-time display (no palette entry)
  // Note: DFM streaming registration (RegisterClasses) is in iORM.MVVM.VMAction initialization
  RegisterNoIcon([
    TioVMActionCustom,
    TioVMAction,
