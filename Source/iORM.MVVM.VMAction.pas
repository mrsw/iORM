...
begin
  ...
  //      questo codice non serve pi� (per ora lo lascio commentato)
...
begin
  _ExecuteOriginal;  // Ritorna all'implementazione originale (cio� esegue la action anche se il TargetBindSource non � assegnato)
  Result := False;
end;
...
begin
  ...
  try
    ...
    // NB: Mauri 23/09/2023: Non c'� pi� dil DoOnConfirmationRequest perch� rimosso perch� ho aggiunto l'evento
